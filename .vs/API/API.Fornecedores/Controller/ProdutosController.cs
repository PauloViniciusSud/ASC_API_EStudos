...
namespace API.Fornecedores.Controller
{
    ...
    public class ProdutosController : MainController
    {
        ...
        [HttpPost("Adicionar")]
        public async Task<ActionResult<ProdutoDTO>> AdicionarAlternativo(ProdutoDTO produtoViewModel)
        {
            if (!ModelState.IsValid) return CustomResponse(ModelState);
        ...
        private async Task<bool> UploadArquivoAlternativo(string arquivo, string imgPrefixo)
        {
            ...
            var path = Path.Combine(Directory.GetCurrentDirectory(), "wwwroot", imgPrefixo + arquivo);
